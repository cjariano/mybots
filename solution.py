...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        #CubeforWeight
        pyrosim.Send_Cube(name="Extra", pos=[0, 0, 1.5], size=[1, 0.4, 0.4])
        ...
        pyrosim.Send_Joint(name="Torso_Extra", parent="Torso", child="Extra", type = "fixed", position=[0, 0, 0.2], jointAxis="0 0 1")
