...
numberOfGenerations = 1 # Number of generations for the genetic algorithm CHANGE BACK TO 10
populationSize = 1 # Size of the population for the genetic algorithm CHANGE BACK TO 10
